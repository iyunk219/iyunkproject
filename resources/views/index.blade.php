                    ...
                    <div class="row justify-content-between"style="padding: 20px 0;">
                        <div class="col-lg-5">
                            <div class="intro-excerpt">
                                ...
                                <p class="mb-4">"Bingung memilih furnitur? Kami hadir dengan koleksi eksklusif yang tidak hanya menawan tetapi juga fungsional. Segera kunjungi toko kami!"</p>
        ...
        <div class="product-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                        <a class="product-item" href="cart.html">
                            <img src="images/2.jpeg" class="img-fluid product-thumbnail" style="width: 100%; height: 250px; object-fit: cover;">
