       ...
       <div class="row justify-content-between">
          <div class="col-lg-5">
             <div class="intro-excerpt">
                 <h1>Desain Interior Modern</h1>
                 <p>"Bingung memilih furnitur? Kami hadir dengan koleksi eksklusif yang tidak hanya menawan tetapi juga fungsional. Segera kunjungi toko kami!"</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
                        ...
                        <p class="mb-4">"Furnitur kami menggabungkan keindahan dan daya tahan, memberikan kenyamanan dan gaya di setiap detail."</p>
                    ...
                    <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                        <a class="product-item" href="cart.html">
                            <img src="images/4.jpeg" class="img-fluid product-thumbnail" style="width: 100%; height: 250px; object-fit: cover;">
                            <h3 class="product-title">Buffet Tv</h3>
                            <strong class="product-price">Rp  2.500.000,00</strong>
                        </a>
                    </div> 
                    <!-- End Column 2 -->
                    ...
                    <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                        <a class="product-item" href="cart.html">
                            <img src="images/ff.jpeg" class="img-fluid product-thumbnail" style="width: 100%; height: 250px; object-fit: cover;">
                            <h3 class="product-title">Kursi Tamu Sudut Box</h3>
                            <strong class="product-price">Rp  11.000.000,00</strong>
                        </a>
                    </div>
                    <!-- End Column 3 -->
                    ...
                    <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                        <a class="product-item" href="cart.html">
                            <img src="images/5.JPG" class="img-fluid product-thumbnail" style="width: 100%; height: 250px; object-fit: cover;">
                            <h3 class="product-title">Meja Makan Bulat</h3>
                            <strong class="product-price">Rp  3.900.000,00</strong>
                        </a>
                    </div>
                    <!-- End Column 4 -->
                        ...
                        <div class="item">
                            <div class="row justify-content-center">
                                <div class="col-lg-8 mx-auto">
                                    ...
                                    <div class="testimonial-block text-center">
                                        <blockquote class="mb-5">
                                            <p>&ldquo;Kualitas furnitur yang saya beli dari Jayamahe sangat memuaskan. Desainnya sesuai dengan gaya rumah saya dan sangat nyaman digunakan. Terima kasih, Jayamahe Furniture!&rdquo;</p>
                                        </blockquote>
                         ...
                         <div class="item">
                            <div class="row justify-content-center">
                                <div class="col-lg-8 mx-auto">
                                    ...
                                    <div class="testimonial-block text-center">
                                        <blockquote class="mb-5">
                                            <p>&ldquo; Barang yang diterima sesuai dengan yang diharapkan dan dalam kondisi baik. Tersedia opsi pembayaran COD dan saya dapat melakukan unboxing sebelum melakukan pembayaran. Ongkos kirim gratis dan harga yang ditawarkan sangat terjangkau. Saya sangat merekomendasikan toko ini.&rdquo;</p>
                                        </blockquote>

                                        <div class="author-info">
                                            <h3 class="font-weight-bold">Apriyanto Ratna</h3>
                                            <span class="position d-block mb-3">Ibu Rumah Tangga, Bogor</span>
                                        </div>
                                    </div>
                         ...
                         <div class="item">
                            <div class="row justify-content-center">
                                <div class="col-lg-8 mx-auto">
                                    ...
                                    <div class="testimonial-block text-center">
                                        <blockquote class="mb-5">
                                            <p>&ldquo;Barang yang diterima sesuai dengan gambar yang ditampilkan, bahkan lebih bagus. saya habis order satu minggu yang lalu&rdquo;</p>
                                        </blockquote>

                                        <div class="author-info">
                                            <h3 class="font-weight-bold">Nia</h3>
