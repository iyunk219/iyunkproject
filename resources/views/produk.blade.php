...
@section('content')
                ...
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        ...
                        <p class="mb-4">Temukan berbagai pilihan furnitur berkualitas tinggi di Jayamahe Furnitur.
                            ...
                            Setiap produk dirancang untuk memberikan kenyamanan dan keindahan di setiap sudut rumah Anda.
                        </p>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="hero-img-wrap" style="text-align: right;">
                        <img src="images/222.jpg" alt="Background Image"
                            style="width: 87%; height: auto; object-fit: cover;  margin-left: auto; display: block;">
                    </div>
                </div>
            </div>
    ...
    <div class="untree_co-section product-section before-footer-section"
        ...
        <div class="container">
            <h2 class="text-center mb-4" style="font-family: Arial, sans-serif; font-size: 2.5em; color: #006400;">Katalog
                Produk</h2>
            <form action="" method="get">

                <div class="mb-4 text-center">
                    <label for="product-filter" class="form-label" style="font-weight: bold; color: #555;">Cari
                        Produk:</label>


                    <!-- Dropdown untuk kategori produk (disembunyikan) -->
                    <select class="form-select select2" onchange="this.form.submit()" name="kategori">
                        <option>-- Pilih --</option>
                        @foreach ($category as $row)
                            <option value="{{ $row->id }}" {{ $row->id == $kategori ? 'selected' : '' }}>
                    ...
                    <div class="col-12 col-md-4 col-lg-3 mb-5 product-item {{ strtolower(trim($data->kategori)) }}">
                        <a href="#" style="text-decoration: none; color: inherit;"
                            ...
                            <h3 class="product-title"
                                style="font-size: 1.5em; font-weight: bold; margin-top: 10px; color: #555555;">
                                {{ $data->nama_produk }}</h3>
                            <strong class="product-price" style="font-size: 1.2em; color: #28A745;">Harga:
                                {{ number_format($data->harga, 2, ',', '.') }}</strong>
                            <p class="product-description" style="font-size: 0.9em; color: #333333; margin-top: 5px;">
                                {{ $data->deskripsi }}</p>
